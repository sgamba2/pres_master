...
\begin{columns}
    ...
    {\footnotesize 
          ...
          \vspace{1.2mm}
          \item digi-FPGAs pulsed \textbf{internally} at $f_{gen}$;
          \vspace{1.2mm}
          \item Each FPGA has its own generator and they are offset ($\in [0 ,T_{gen}]$) wrt each other;
          \vspace{1.2mm}
          ...
          \vspace{1.2mm}
      \item ROC internal \textbf{hit buffer} stores up to \textbf{255 hits};
      \vspace{1.2mm}

      
          }
          {\footnotesize\item Depending on $T_{gen}=1/f_{gen}$ and $T_{EW}$, data taking can proceed in 2 modes:}
    \vspace{0.9mm}
\begin{itemize}
...
{\footnotesize
\vspace{1.2mm}
\item Generator timing uncorrelated with the EW $\rightarrow$ different number of hits in an EW;
\vspace{1.2mm}
...
\begin{frame}
  ...
  \vspace{2mm}
                \item \textbf{Calibration}: from $\Delta t_{12}$ and $x_{\text{track}}$ $\rightarrow$ $v$;
              \vspace{2mm}
...
\begin{column}{0.65\framewidth}
   \setlength{\leftmargini}{1.2em}
      \begin{itemize}
      {\footnotesize \item \textbf{Cosmics as calibration source}:}
      \begin{itemize}
    {\footnotesize \item standard detector operations;
...
\vspace{1.2mm}
   ...
   \begin{itemize}
      \vspace{1.2mm}
      {\small \item \textbf{DAQ} and \textbf{FEE} testing:}
   \vspace{1mm}
      \begin{itemize}
...
cross-talk, and waveform patterns study.}
 \end{itemize}
    \vspace{1.2mm}
    {\small \item \textbf{First steps towards timing calibration}:}
  \vspace{1mm}
 \begin{itemize}
 ...
 \end{itemize}
   \vspace{1.2mm}
   {\small \item \textbf{Pre-pattern recognition study} to flag $\delta$-electrons:}
  \vspace{1mm}
  \begin{itemize}
