...
\begin{frame}
    \frametitle{Muon selection and reconstruction}
\vspace{-4.6mm}
    \begin{columns}
\begin{column}{0.65\framewidth}
   \setlength{\leftmargini}{1.2em}
...
\begin{frame}
    \frametitle{Possible CLFV models}
...
\begin{frame}
    \frametitle{determine channel to channel delay}
    contenuto terza slide
\end{frame}
\begin{frame}
    \frametitle{distribuzione dei raggi cosmic}
    contenuto terza slide
\end{frame}

\begin{frame}
    \frametitle{plot dei raggi cosmici con le nostre selezioni}
    contenuto terza slide
\end{frame}
